...
func UTF16ToRunes(b []byte) []rune {
	...
	if len(b)%2 != 0 {
		b = append(b, 0)
		_g.Log.Debug("E\u0052\u0052\u004f\u0052\u003a\u0020\u0055\u0054\u0046\u0031\u0036\u0054\u006f\u0052\u0075\u006e\u0065\u0073.\u0020\u0050\u0061\u0064\u0064\u0069\u006e\u0067\u0020\u0077it\u0068\u0020\u007ae\u0072o\u0073\u002e")
	}
	_dc := len(b) >> 1
	_fff := make([]uint16, _dc)
	for _a := 0; _a < _dc; _a++ {
		_fff[_a] = uint16(b[_a<<1])<<8 + uint16(b[_a<<1+1])
	}
	_dd := _ff.Decode(_fff)
	return _dd
}
...
func init() {
	_c = map[rune]byte{}
	for _fd, _db := range _ggf {
		_c[_db] = _fd
	}
}

func PDFDocEncodingToString(b []byte) string { return string(PDFDocEncodingToRunes(b)) }
...
func PDFDocEncodingToRunes(b []byte) []rune {
	...
	for _, _ca := range b {
		_fc, _gf := _ggf[_ca]
		if !_gf {
			_g.Log.Debug("\u0045\u0072\u0072\u006f\u0072\u003a\u0020P\u0044\u0046\u0044o\u0063\u0045\u006ec\u006f\u0064i\u006e\u0067\u0020\u0069\u006e\u0070u\u0074 m\u0061\u0070\u0070\u0069\u006e\u0067\u0020\u0065\u0072\u0072\u006f\u0072\u0020\u0025\u0064\u0020\u002d\u0020\u0073\u006b\u0069\u0070\u0070\u0069\u006e\u0067", _ca)
			continue
		}
		_cd = append(_cd, _fc)
	}
...
func StringToUTF16(s string) string {
	_dbc := _ff.Encode([]rune(s))
	var _ga _f.Buffer
	for _, _ag := range _dbc {
		_ga.WriteByte(byte((_ag >> 8) & 0xff))
		_ga.WriteByte(byte(_ag & 0xff))
	}
	return _ga.String()
}
...
func StringToPDFDocEncoding(s string) []byte {
	...
	for _, _dcf := range s {
		_af, _dbe := _c[_dcf]
		if !_dbe {
			_g.Log.Debug("\u0045\u0052\u0052\u004f\u0052\u003a\u0020\u0050\u0044\u0046\u0044\u006f\u0063\u0045\u006e\u0063\u006f\u0064\u0069\u006eg\u0020\u0072\u0075\u006e\u0065\u0020\u006d\u0061\u0070\u0070\u0069\u006e\u0067\u0020\u006d\u0069\u0073\u0073\u0069\u006e\u0067\u0020\u0025\u0063\u002f\u0025\u0058\u0020\u002d\u0020s\u006b\u0069\u0070\u0070\u0069n\u0067", _dcf, _dcf)
			continue
		}
		_agg.WriteByte(_af)
	}
