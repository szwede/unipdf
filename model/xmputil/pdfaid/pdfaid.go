...
func (_da *Model) Namespaces() _e.NamespaceList { return _e.NamespaceList{Namespace} }

func init() { _e.Register(Namespace, _e.XmpMetadata); _g.RegisterSchema(Namespace, &Schema) }

// MakeModel gets or create sa new model for PDF/A ID namespace.
func MakeModel(d *_e.Document) (*Model, error) {
	_bd, _cf := d.MakeModel(Namespace)
	if _cf != nil {
		return nil, _cf
	}
	return _bd.(*Model), nil
}

// SetTag implements xmp.Model interface.
func (_aab *Model) SetTag(tag, value string) error {
	if _ff := _e.SetNativeField(_aab, tag, value); _ff != nil {
		return _f.Errorf("\u0025\u0073\u003a\u0020\u0025\u0076", Namespace.GetName(), _ff)
	}
	return nil
}
